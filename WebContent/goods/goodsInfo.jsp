...
<form action="goodsUp.do" method="post">
...
<div class="input-group">
  ...
  <input type="text" name="price" class="form-control" placeholder="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group">
  <span class="input-group-addon" id="basic-addon1">재고량</span>
  <input type="text" name="stock" class="form-control" placeholder="Username" aria-describedby="basic-addon1">
</div>
